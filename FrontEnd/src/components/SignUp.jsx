...
import { addNewUser, getAllUserDatasFP,/* getAllUserDatas */} from '../assets/Json Related Things/JSONAPI';
  ...
  const sub=(event)=>
  {
    ...
    else
    {
      ...
      if(nameexistorno===-1&&Emexistorno===-1)
      {
        ...
        // const em =CheckEmailExist(udata.email).then((res)=>{return(res.data)});
        // const na =CheckEmailExist(udata.name).then((res)=>{return(res.data)});
        // console.log(em,na);
        // if(na===-1&&em===-1)
        // {
        //   addNewUser(udata);
